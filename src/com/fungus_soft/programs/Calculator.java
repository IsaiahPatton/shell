...
public class Calculator extends JProgram {
    ...
    public Calculator() {
        ...
        ((JButton)simple.add(new ModernButton("C"))).addActionListener(l -> {
            operator = "C";
            calculate(0);
        });

        ((JButton)simple.add(new ModernButton("+-"))).addActionListener(l -> {
            operator = "neg";
        ...
        simple.add(new ModernButton(""));

        for (int i = 0; i < buttonLabels.length(); i++) {
            int i_final = i;
            JButton btn = ((JButton)simple.add(new ModernButton(buttonLabels.substring(i, i + 1))));
